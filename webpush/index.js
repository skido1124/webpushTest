$(document).ready(function(){
    ...
    if ("serviceWorker" in navigator &&
        ...
        // ServiceWorker 登録
        navigator.serviceWorker.register("/js/webpush/service_worker.js").then(
    ...
    function subscribe() {
        ...
        navigator.serviceWorker.getRegistration("/js/webpush/service_worker.js").then(function(swr) {
